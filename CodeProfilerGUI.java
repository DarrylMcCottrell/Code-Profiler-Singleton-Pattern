...
public class CodeProfilerGUI extends JFrame 
{
    //hold the hashmaps from the the CodeProfiler
    ...
    public CodeProfilerGUI (HashMap <String, ArrayList <Duration>> t, HashMap <String, Integer> c) throws ClassNotFoundException, InstantiationException
	{

        super("Code Profiler Report");
    ...
    private void fillTimersTab ()
	{
        ...
        while(iter.hasNext())
		{
            ...
            Map.Entry<?,?> hashMapEntry = (Map.Entry)iter.next();
