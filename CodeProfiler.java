...
public class CodeProfiler {
    ...
    public static CodeProfiler getInstance()
	{
        if(instance == null){
    ...
    //start a timer
    public void start(String title, String message) throws CodeProfilerException {
            ...
            //try {
                ...
                if(ref.size() > 0){
                    ...
                    //else, the last timer was not stopped and we cannot start a new one
                        ...
                        //throw exception
                        throw new CodeProfilerException("Cannot Start Timer: Previous Timer Left Unstopped");
                    }
                }
    ...
    public void start(String title) throws CodeProfilerException {
    ...
    public void stop(String title, String message) throws CodeProfilerException {
        ...
        if(isEnabled()){
            ...
            //try {
                ...
                if(ref == null){
                    throw new CodeProfilerException("Cannot End Timer: No Timer List Found");
                }
                ...
                if(ref.size() > 0){
                    ...
                    //else, you cannot end an unstarted timer
                        ...
                        throw new CodeProfilerException("Cannot End Timer: Invalid Start Value Detected");
                    }
                }
                else {
                    //the size is 0 or less, there are no timers to end. Throw exception
                    throw new CodeProfilerException("Cannot End Timer: No Timers to End");
                }
            //}
    ...
    public void stop(String title) throws CodeProfilerException {
    ...
    */
    public void generateReport() throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        if(isEnabled()){
            new CodeProfilerGUI(timers, counters);
        }
    }
